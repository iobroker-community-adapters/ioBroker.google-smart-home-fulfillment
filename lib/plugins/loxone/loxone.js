...
class Loxone {
    ...
    async lightDeviceBuilder(id, device) {
        ...
        // Above now always returns strings when we know they are arrays... urgh!
        // TODO: have some checking around this
        moodList.val = JSON.parse(moodList.val);
    ...
    async lightQueryHandler(id) {
        ...
        // TODO: make this a function and call from above too.
        activeMoods.val = JSON.parse(activeMoods.val);
